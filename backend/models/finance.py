...
class AccountExport(BaseModel):
    ...
    subscription_candidates: list[dict] = []
    email_connections: list[dict] = []
    assistant_messages: list[dict]
    assistant_usage: list[dict] = []
    digest_prefs: list[dict] = []
    gaming_purchases: list[dict] = []
    gaming_watches: list[dict] = []
    gaming_price_overrides: list[dict] = []
    gaming_price_history: list[dict] = []
